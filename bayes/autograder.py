...
PROJECT_NAME = 'Assignment 3: Bayes Nets'
PROJECT_TEST_CLASSES = 'bayesNets2TestClasses.py'

# register arguments and set default values
def readCommand(argv):
    parser = optparse.OptionParser(description = 'Run public tests on student code')
    parser.set_defaults(generateSolutions=False, gsOutput=False, printTestCase=False, noGraphics=False)
...
def runTest(testName, moduleDict, printTestCase=False, display=None):
    ...
    grades = grading.Grades(PROJECT_NAME, [(None,0)])
...
def evaluate(testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP, gsOutput=False,
    ...
    grades = grading.Grades(PROJECT_NAME, questions, gsOutput=gsOutput)
    if questionToGrade == None:
...
if __name__ == '__main__':
    ...
    codePaths = ['factorOperations.py', 'inference.py', 'bayesAgents.py']
